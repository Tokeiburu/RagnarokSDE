...
namespace SDE.Editor.Generic.Lists {
	public sealed class ServerDbs {
		...
		public static readonly ServerDbs ItemsFlag = new ServerDbs("item_flag") { DisplayName = "Item>Flag" };
		...
		public static readonly ServerDbs Items2 = new ServerDbs("item_db2") { DisplayName = "Item2", SupportedFileType = FileType.Conf | FileType.Txt | FileType.Sql | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\item_db", IsImport = true };
		public static readonly ServerDbs Items = new ServerDbs("item_db") { DisplayName = "Item", SupportedFileType = FileType.Conf | FileType.Txt | FileType.Sql | FileType.Yaml, AdditionalTable = Items2 };
		public static readonly ServerDbs Mobs2 = new ServerDbs("mob_db2") { DisplayName = "Mob2", SupportedFileType = FileType.Txt | FileType.Sql | FileType.Conf | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\mob_db", IsImport = true };
		public static readonly ServerDbs Mobs = new ServerDbs("mob_db") { DisplayName = "Mob", SupportedFileType = FileType.Txt | FileType.Sql | FileType.Conf | FileType.Yaml, AdditionalTable = Mobs2 };
		...
		public static readonly ServerDbs Skills2 = new ServerDbs("skill_db2") { DisplayName = "Skill2", SupportedFileType = FileType.Txt | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\skill_db", IsImport = true };
		public static readonly ServerDbs Skills = new ServerDbs("skill_db") { DisplayName = "Skill", SupportedFileType = FileType.Txt | FileType.Yaml, UseSubPath = true, AdditionalTable = Skills2 };
		...
		public static readonly ServerDbs Pet2 = new ServerDbs("pet_db2") { DisplayName = "Pet2", SupportedFileType = FileType.Txt | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\pet_db", IsImport = true };
		public static readonly ServerDbs Pet = new ServerDbs("pet_db") { DisplayName = "Pet", SupportedFileType = FileType.Txt | FileType.Yaml, UseSubPath = false, AdditionalTable = Pet2 };
		...
		public static readonly ServerDbs Quests2 = new ServerDbs("quest_db2") { DisplayName = "Quest2", UseSubPath = false, SupportedFileType = FileType.Conf | FileType.Txt | FileType.Yaml, AlternativeName = "import\\quest_db", IsImport = true };
		...
		public static readonly ServerDbs Cheevo2 = new ServerDbs("achievement_db2") { DisplayName = "Cheevos", SupportedFileType = FileType.Conf | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\achievement_db", IsImport = true };
		public static readonly ServerDbs Cheevo = new ServerDbs("achievement_db") { DisplayName = "Cheevos", SupportedFileType = FileType.Conf | FileType.Yaml, UseSubPath = false, AdditionalTable = Cheevo2 };
