...
namespace SDE.Tools.DatabaseEditor.Generic.Lists {
	public sealed class ServerDBs {
		...
		public static readonly ServerDBs Items = new ServerDBs("item_db") { DisplayName = "Item", SupportedFileType = FileType.Conf | FileType.Txt | FileType.Sql };
		...
		public static readonly ServerDBs Mobs = new ServerDBs("mob_db") { DisplayName = "Mob", SupportedFileType = FileType.Txt | FileType.Sql };
		...
		public static readonly ServerDBs MobSkills = new ServerDBs("mob_skill_db") { DisplayName = "Mob Skills", SupportedFileType = FileType.Txt | FileType.Sql };
