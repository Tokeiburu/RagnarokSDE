...
namespace SDE.Tools.DatabaseEditor.Generic.Lists {
	public sealed class ServerMobAttributes : DbAttribute {
		...
		public static readonly DbAttribute SpriteName = new ServerMobAttributes(new DbAttribute("SpriteName", typeof(string), "", "Sprite name")) { Description = "This is the resource name of the sprite that will be used by the client." };
		...
		public static readonly DbAttribute Atk2 = new ServerMobAttributes(new DbAttribute("Atk2", typeof(CustomAttackProperty), "0", "Max attack")) { DataConverter = ValueConverters.GetSetZeroString, Description = "The maximum attack of the mob. If set to 0, the value will be the same as the minimum attack." };
		...
		public static readonly DbAttribute Size = new ServerMobAttributes(new DbAttribute("Size", typeof(ScaleType), "0")) { DataConverter = ValueConverters.GetIntSetEmptyString };
		public static readonly DbAttribute Race = new ServerMobAttributes(new DbAttribute("Race", typeof(MobRaceType), "0")) { DataConverter = ValueConverters.GetIntSetEmptyString };
	...
	public sealed class ServerItemAttributes : DbAttribute {
		...
		public static readonly DbAttribute Type = new ServerItemAttributes(new DbAttribute("Type", typeof(TypeType), "")) { DataConverter = ValueConverters.GetIntSetZeroString, Description = "They type defines the default behavior of the item.", IsSearchable = false };
		...
		public static readonly DbAttribute Trade = new ServerItemAttributes(new DbAttribute("Trade", typeof(TradeProperty), null, "Trade")) { DataConverter = ValueConverters.GetSetTypeTrade, Description = "Trading restrictions (can't be dropped, traded, etc)." };
		public static readonly DbAttribute Nouse = new ServerItemAttributes(new DbAttribute("Nouse", typeof(NouseProperty), null, "No use")) { DataConverter = ValueConverters.GetSetTypeNouse, Description = "Conditions to make the item not usable." };
	...
	public sealed class ServerHomunAttributes : DbAttribute {
		...
		public static readonly DbAttribute BaseSize = new ServerHomunAttributes(new DbAttribute("BaseSize", typeof(ScaleType), "0", "Base size")) { Description = "Size of the base homunculus class." };
		public static readonly DbAttribute EvoSize = new ServerHomunAttributes(new DbAttribute("EvoSize", typeof(ScaleType), "0", "Evolution size")) { Description = "Size of the evolved homunculus class." };
	...
	public sealed class ServerItemGroupAttributes : DbAttribute {
		...
		public static readonly DbAttribute Display = new ServerItemGroupAttributes(new DbAttribute("Display name", typeof(ItemGroupBinding), null));
	...
	public sealed class ServerSkillRequirementsAttributes : DbAttribute {
		...
		public static readonly DbAttribute Display = new ServerSkillRequirementsAttributes(new DbAttribute("Name", typeof(MobSkillBinding), null)) { IsDisplayAttribute = true, Visibility = VisibleState.Hidden };
